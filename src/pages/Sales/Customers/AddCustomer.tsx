          ...
          {({ handleChange, values, errors, touched }) => (
            <Form className="p-6.5">
              ...
              <div className="pt-4 mt-4 border-t border-stroke dark:border-strokedark flex justify-end gap-3">
                <button type="button" onClick={() => navigate('/customers/list')} className="bg-danger text-white py-2 px-8 rounded font-medium hover:bg-opacity-90 transition shadow-sm" >
                  Cancel
                </button>
                <button type="submit" disabled={loading} className={`rounded ${isEditMode ? "bg-success" : "bg-primary"} py-2 px-10 font-medium text-white hover:bg-opacity-90 transition disabled:bg-opacity-50`}>
